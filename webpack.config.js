...
module.exports = {
    ...
    module: {
        rules: [
            {
                test : /\.(js|jsx)$/, // 자바스크립트 최신 문법을 구형 브라우저에서도 동작하게 설정
            ...
            {
                test: /\.scss$/,
                use: ["css-loader", "sass-loader"] // SASS 빌드
            },
            {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
          template: "src/index.html", // html 파일 설정
          favicon: "favicon.png" // 파비콘 경로 설정
        }),
